	...
	<div id="eis_all">
        ...
        <div id="eis_contents">
            ...
            <div>
            	<div id="eis_home">
                	<div id="eih_left">
                        <div style="font-size:xx-large; color:#036; margin:10px 0px;">Lecturer Log In >></div>
                        <b><u>PLEASE LOGIN HERE</u></b><br /><br />  
						<?php include('logics/l_login.php'); ?> 
                         <form action="l_login.php" method="post" enctype="multipart/form-data">
                            <table>
                                <tr>
                                    <td colspan="2">If you are a Student, please <a href="login.php">Click Here</a> to Login</td>
                                </tr>
                                <tr>
                                    <td><b>Username:</b></td>
                                    <td>
